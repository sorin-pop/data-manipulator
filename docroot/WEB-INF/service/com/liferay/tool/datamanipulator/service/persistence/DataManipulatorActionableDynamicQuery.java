...
public abstract class DataManipulatorActionableDynamicQuery
	...
	public DataManipulatorActionableDynamicQuery() throws SystemException {
		setBaseLocalService(DataManipulatorLocalServiceUtil.getService());
		setClass(DataManipulator.class);

		setClassLoader(com.liferay.tool.datamanipulator.service.ClpSerializer.class.getClassLoader());
