 ...
 *
 */
public class UserHandler extends AbstractPortletHandler
	...
	public void startGenerate(RequestProcessor requestProcessor)
		...
		int userCount = requestProcessor.getCount(EntryTypeKeys.PORTAL_USER);
		...
		EntryHandlerModel userHandler = new UserEntryHandler(
			userCount, 0, 0, 0, userEntry, null, requestProcessor);
